    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <div className="flex flex-col rounded-2xl border border-[var(--border)] bg-[color-mix(in_oklab,var(--elevated)_50%,transparent)] p-5 shadow-sm">
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm text-[var(--muted)]">JLPT tracks · N5 to N3</p>
        </div>
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-0.5 text-xs text-[var(--muted)]">{t("hub.japanese.subtitle")}</p>
              </div>
              <span
            ...
            <span className="mt-3 text-xs font-medium text-[var(--accent)] transition group-hover:brightness-110">
              {t("hub.backend.cta")}
            </span>
          </Link>
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-0.5 text-xs text-[var(--muted)]">{t("hub.japaneseN4.subtitle")}</p>
              </div>
              <span
                className="shrink-0 rounded-full bg-[var(--elevated)] px-2 py-0.5 text-xs font-semibold tabular-nums text-[var(--accent)]"
                suppressHydrationWarning
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-0.5 text-xs text-[var(--muted)]">{t("hub.japaneseN3.subtitle")}</p>
              </div>
              <span
                className="shrink-0 rounded-full bg-[var(--elevated)] px-2 py-0.5 text-xs font-semibold tabular-nums text-[var(--accent)]"
                suppressHydrationWarning
