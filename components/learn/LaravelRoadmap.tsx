...
import { LARAVEL_DAY_3_LESSONS } from "@/lib/laravel-learning/laravel-day-3-lessons";
import { LARAVEL_DAY_4_LESSONS } from "@/lib/laravel-learning/laravel-day-4-lessons";
import { LARAVEL_DAY_5_LESSONS } from "@/lib/laravel-learning/laravel-day-5-lessons";
import { LARAVEL_DAY_6_LESSONS } from "@/lib/laravel-learning/laravel-day-6-lessons";
import { LARAVEL_DAY_7_LESSONS } from "@/lib/laravel-learning/laravel-day-7-lessons";
import { LARAVEL_DAY_8_LESSONS } from "@/lib/laravel-learning/laravel-day-8-lessons";
...
import { LARAVEL_DAY_13_LESSONS } from "@/lib/laravel-learning/laravel-day-13-lessons";
import { LARAVEL_DAY_14_LESSONS } from "@/lib/laravel-learning/laravel-day-14-lessons";
import { LARAVEL_DAY_15_LESSONS } from "@/lib/laravel-learning/laravel-day-15-lessons";
import { LARAVEL_DAY_16_LESSONS } from "@/lib/laravel-learning/laravel-day-16-lessons";
import { LARAVEL_DAY_17_LESSONS } from "@/lib/laravel-learning/laravel-day-17-lessons";
import { LARAVEL_DAY_18_LESSONS } from "@/lib/laravel-learning/laravel-day-18-lessons";
import { LARAVEL_DAY_19_LESSONS } from "@/lib/laravel-learning/laravel-day-19-lessons";
import { LARAVEL_DAY_20_LESSONS } from "@/lib/laravel-learning/laravel-day-20-lessons";
import { LARAVEL_DAY_21_LESSONS } from "@/lib/laravel-learning/laravel-day-21-lessons";
import { LARAVEL_DAY_22_LESSONS } from "@/lib/laravel-learning/laravel-day-22-lessons";
import { LARAVEL_DAY_23_LESSONS } from "@/lib/laravel-learning/laravel-day-23-lessons";
import { LARAVEL_DAY_24_LESSONS } from "@/lib/laravel-learning/laravel-day-24-lessons";
import { LARAVEL_DAY_25_LESSONS } from "@/lib/laravel-learning/laravel-day-25-lessons";
import { LARAVEL_DAY_26_LESSONS } from "@/lib/laravel-learning/laravel-day-26-lessons";
import { LARAVEL_DAY_27_LESSONS } from "@/lib/laravel-learning/laravel-day-27-lessons";
import { LARAVEL_DAY_28_LESSONS } from "@/lib/laravel-learning/laravel-day-28-lessons";
import { LARAVEL_DAY_29_LESSONS } from "@/lib/laravel-learning/laravel-day-29-lessons";
import { LARAVEL_DAY_30_LESSONS } from "@/lib/laravel-learning/laravel-day-30-lessons";
import { LARAVEL_DAY_31_LESSONS } from "@/lib/laravel-learning/laravel-day-31-lessons";
import { LARAVEL_DAY_32_LESSONS } from "@/lib/laravel-learning/laravel-day-32-lessons";
import { LARAVEL_DAY_33_LESSONS } from "@/lib/laravel-learning/laravel-day-33-lessons";
...
const LARAVEL_LESSON_DAYS: Record<number, LessonDay> = {
  ...
  3: LARAVEL_DAY_3_LESSONS,
  4: LARAVEL_DAY_4_LESSONS,
  5: LARAVEL_DAY_5_LESSONS,
  6: LARAVEL_DAY_6_LESSONS,
  7: LARAVEL_DAY_7_LESSONS,
  8: LARAVEL_DAY_8_LESSONS,
  9: LARAVEL_DAY_9_LESSONS,
  10: LARAVEL_DAY_10_LESSONS,
  11: LARAVEL_DAY_11_LESSONS,
  12: LARAVEL_DAY_12_LESSONS,
  13: LARAVEL_DAY_13_LESSONS,
  14: LARAVEL_DAY_14_LESSONS,
  15: LARAVEL_DAY_15_LESSONS,
  16: LARAVEL_DAY_16_LESSONS,
  17: LARAVEL_DAY_17_LESSONS,
  18: LARAVEL_DAY_18_LESSONS,
  19: LARAVEL_DAY_19_LESSONS,
  20: LARAVEL_DAY_20_LESSONS,
  21: LARAVEL_DAY_21_LESSONS,
  22: LARAVEL_DAY_22_LESSONS,
  23: LARAVEL_DAY_23_LESSONS,
  24: LARAVEL_DAY_24_LESSONS,
  25: LARAVEL_DAY_25_LESSONS,
  26: LARAVEL_DAY_26_LESSONS,
  27: LARAVEL_DAY_27_LESSONS,
  28: LARAVEL_DAY_28_LESSONS,
  29: LARAVEL_DAY_29_LESSONS,
  30: LARAVEL_DAY_30_LESSONS,
  31: LARAVEL_DAY_31_LESSONS,
  32: LARAVEL_DAY_32_LESSONS,
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-24 pt-8 sm:px-6">
      <div className="mb-10 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-[var(--text)] sm:text-3xl">{t("laravelRoadmap.title")}</h1>
          <p className="mt-1 text-sm text-[var(--muted)]">{t("laravelRoadmap.subtitle")}</p>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-between gap-3">
          <span className="text-sm text-[var(--muted)]">{t("laravelRoadmap.overallProgress")}</span>
          <div className="flex items-center gap-3">
            <span className="text-sm tabular-nums text-[var(--text)]">
              {completedCount}/{LARAVEL_TOTAL_DAYS} {t("hub.backend.days")}
            </span>
          </div>
        </div>
        ...
        <p className="mt-2 text-right text-xs text-[var(--muted)]">
          {percent}
          {t("laravelRoadmap.percentComplete")}
        </p>
      </div>

      <div className="mt-8 flex flex-col gap-10" id="laravel-roadmap-days" aria-label={t("laravelRoadmap.daysListAria")}>
        {LARAVEL_ROADMAP_WEEKS.map((week) => (
          <div key={week.id}>
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      <button
                        ...
                        onClick={() => (LARAVEL_LESSON_DAYS[d.day] ? setLessonDay(d.day) : setDetailDay(d.day))}
                      >
                        <span
                          className={[
      ...
      <div className="mt-14 flex flex-col items-center gap-4" id="laravel-roadmap-bottom">
        <button
          type="button"
          ...
          onClick={() => document.getElementById("laravel-roadmap-blurb")?.scrollIntoView({ behavior: "smooth" })}
        >
        ...
        <p id="laravel-roadmap-blurb" className="max-w-2xl text-center text-sm leading-relaxed text-[var(--muted)]">
      ...
      {lessonDay !== null && (
        <LessonDayDetail
          key={`laravel-lesson-day-${lessonDay}`}
          open
