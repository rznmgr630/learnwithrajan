...
import { getAllNodejsRoadmapDays, NODEJS_TOTAL_DAYS } from "@/lib/nodejs-learning/nodejs-challenge-data";
...
export function NodejsRoadmap() {
  ...
  const allDays = useMemo(() => getAllNodejsRoadmapDays(), []);
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-24 pt-8 sm:px-6">
      ...
      <ul className={`mt-8 ${dayGridClass}`} id="nodejs-roadmap-days" aria-label={t("nodejsRoadmap.daysListAria")}>
        {allDays.map((d) => {
