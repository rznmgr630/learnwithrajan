...
import { DISCIPLINE_VIDEOS } from "@/lib/personal-development/discipline-data";
      ...
      <div className="relative overflow-hidden border-b border-[var(--border)]">
        ...
        <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
          ...
          <div className="mt-6 flex items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-4 py-2 w-fit">
            <span className="font-mono text-xl font-bold text-[var(--accent)]">{DISCIPLINE_VIDEOS.length}</span>
