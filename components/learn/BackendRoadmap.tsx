  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pb-24 pt-8 sm:px-6">
      <div className="mb-10 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-[var(--text)] sm:text-3xl">{t("backendRoadmap.title")}</h1>
          <p className="mt-1 text-sm text-[var(--muted)]">{t("backendRoadmap.subtitle")}</p>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-between gap-3">
          <span className="text-sm text-[var(--muted)]">{t("backendRoadmap.overallProgress")}</span>
      ...
      <div className="mt-14 flex flex-col items-center gap-4" id="roadmap-bottom">
        ...
        <p id="roadmap-blurb" className="max-w-2xl text-center text-sm leading-relaxed text-[var(--muted)]">
