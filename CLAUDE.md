...
- **Laravel roadmap** — `lib/laravel-learning/`, `components/learn/LaravelRoadmap.tsx` — 36 days / 9 weeks, novice-to-ninja
...
Track structure: Laravel = 9 weeks / 36 days (MVC → deployment). React = 10 weeks / 27 days (JSX → production architecture).
