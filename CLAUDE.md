...
- **Laravel roadmap** — `lib/laravel-learning/`, `components/learn/LaravelRoadmap.tsx` — 25 days / 8 weeks, novice-to-ninja
...
Track structure: Laravel = 8 weeks / 25 days (MVC → deployment). React = 10 weeks / 27 days (JSX → production architecture).
