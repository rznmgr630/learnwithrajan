...
- **Laravel roadmap** — `lib/laravel-learning/`, `components/learn/LaravelRoadmap.tsx` — 41 days / 10 weeks, novice-to-ninja
...
Track structure: Laravel = 10 weeks / 41 days (MVC → deployment). React = 10 weeks / 27 days (JSX → production architecture).
