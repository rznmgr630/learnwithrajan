...
- **Laravel roadmap** — `lib/laravel-learning/`, `components/learn/LaravelRoadmap.tsx` — 42 days / 11 weeks, novice-to-ninja
...
Track structure: Laravel = 11 weeks / 42 days (MVC → deployment). React = 10 weeks / 27 days (JSX → production architecture).
