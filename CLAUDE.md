...
- **Laravel roadmap** — `lib/laravel-learning/`, `components/learn/LaravelRoadmap.tsx` — 39 days / 10 weeks, novice-to-ninja
...
Track structure: Laravel = 10 weeks / 39 days (MVC → deployment). React = 10 weeks / 27 days (JSX → production architecture).
