...
- **Laravel roadmap** — `lib/laravel-learning/`, `components/learn/LaravelRoadmap.tsx` — 46 days / 13 weeks, novice-to-ninja
...
Track structure: Laravel = 13 weeks / 46 days (MVC → deployment). React = 10 weeks / 27 days (JSX → production architecture).
