...
- **Laravel roadmap** — `lib/laravel-learning/`, `components/learn/LaravelRoadmap.tsx` — 34 days / 8 weeks, novice-to-ninja
...
Track structure: Laravel = 8 weeks / 34 days (MVC → deployment). React = 10 weeks / 27 days (JSX → production architecture).
