...
Status codes and whether they deserve a log entry
  ...
  429 Too Many Req.     the client (Day 23)      the PATTERN, not each hit
...
Log::withContext() vs the Context facade
  ...
  Queues are Day 19. For now, just know Context is the tool.
...
// identifiers travel with it. Queues are Day 19.
...
// If you need to debug production, read the logs.`,
      ...
      keyTakeaways: [
        ...
        "A queued job runs later in a separate process, so without shared context its log lines are orphans (Day 19).",
      ...
      quiz: [
        ...
        },
        {
          ...
          correctIndex: 2,
          explanation: "Queues are Day 19, but this is the reason to remember Context exists.",
        },
        {
