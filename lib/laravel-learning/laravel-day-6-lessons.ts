...
APP_URL=https://invoicehub.com`,
  ...
  project: {
    ...
    steps: [
      ...
      "Alias it as `role` in `bootstrap/app.php` and protect your admin group from Day 5 with `role:admin`.",
    ...
    stretch: [
      "Swap your role middleware order to `['role:admin', 'auth']` once real auth exists on Day 16, observe the 403, and confirm it matches the ordering bug from this lesson.",
