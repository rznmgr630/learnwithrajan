...
APP_URL=https://invoicehub.com`,
  ...
  project: {
    ...
    stretch: [
      "Swap your role middleware order to `['role:admin', 'auth']` once real auth exists on Day 17, observe the 403, and confirm it matches the ordering bug from this lesson.",
