...
enum Status: string
{
    ...
    case Paid  = 'paid';
      ...
      keyTakeaways: [
        ...
        "None of these validate. <b>`integer('abc')` returns `0`</b>, not an error. Validation is Day 8.",
      ],
      commonMistakes: [
