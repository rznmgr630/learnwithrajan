...
const LARAVEL_TAG: Record<string, LocalizedString> = {
  ...
  collections: { en: "collections", np: "Collections", jp: "コレクション" },
  jobs: { en: "jobs", np: "Jobs", jp: "ジョブ" },
...
const LARAVEL_WEEK_TITLE: Record<string, LocalizedString> = {
  ...
  "laravel-w5": {
    ...
    np: "Phase 4 · Security (दिन 18–21)",
    jp: "Phase 4 · セキュリティ（Day 18–21）",
  },
  "laravel-w5b": {
  ...
  "laravel-w5c": {
    en: "Phase 6 · Background Work and Real Time (Days 25–27)",
    np: "Phase 6 · Background Work र Real Time (दिन 25–27)",
    jp: "Phase 6 · バックグラウンド処理とリアルタイム（Day 25–27）",
  },
  "laravel-w5d": {
    en: "Phase 7 · Testing and Quality (Days 28–29)",
    np: "Phase 7 · Testing र Quality (दिन 28–29)",
    jp: "Phase 7 · テストと品質（Day 28–29）",
  },
  "laravel-w5e": {
    en: "Phase 8 · AI and Search (Days 30–31)",
    np: "Phase 8 · AI र Search (दिन 30–31)",
    jp: "Phase 8 · AIと検索（Day 30–31）",
  },
  "laravel-w5f": {
    en: "Phase 9 · Performance and Deployment (Electives, Days 32–33)",
    np: "Phase 9 · Performance र Deployment (Electives, दिन 32–33)",
    jp: "Phase 9 · パフォーマンスとデプロイ（選択・Day 32–33）",
  },
};
