...
export const N5_LESSON_PAGES: N5LessonPageData[] = [
  ...
  // ─── WEEK 2 ───────────────────────────────────────────────────────────────
  {
    ...
    conversation: [
      ...
      {
        speaker: "A",
        japanese: "そのつくえもあたらしいですか。",
        reading: "Sono tsukue mo atarashii desu ka?",
        english: { en: "Is that desk new too?", np: "त्यो टेबल पनि नयाँ हो?" },
      },
      {
        speaker: "B",
        japanese: "いいえ、それはふるいです。でも、おおきいですよ。",
        reading: "Iie, sore wa furui desu. Demo, ōkii desu yo.",
        english: { en: "No, that is old. But it is big.", np: "होइन, त्यो पुरानो हो। तर ठूलो छ है।" },
      },
      {
        speaker: "A",
        japanese: "へやはちいさいですが、つくえはおおきいですね。",
        reading: "Heya wa chiisai desu ga, tsukue wa ōkii desu ne.",
        english: { en: "The room is small, but the desk is big, isn't it.", np: "कोठा सानो छ, तर टेबल ठूलो छ, हगि।" },
      },
      {
        speaker: "B",
        japanese: "はい、そうです。とてもべんりです。",
        reading: "Hai, sō desu. Totemo benri desu.",
        english: { en: "Yes, that's right. It is very convenient.", np: "हो, त्यस्तै हो। धेरै सुविधाजनक छ।" },
      },
      // ── 2. Weather & health small talk ────────────────────────────────────
      {
        speaker: "A",
        japanese: "きょうはいいてんきですね。",
        reading: "Kyō wa ii tenki desu ne.",
        english: { en: "Today's weather is nice, isn't it.", np: "आज मौसम राम्रो छ, हगि।" },
      },
      {
        speaker: "B",
        japanese: "そうですね。とてもあついですね。",
        reading: "Sō desu ne. Totemo atsui desu ne.",
        english: { en: "Yes. It is very hot, isn't it.", np: "हो। धेरै गर्मी छ, हगि।" },
      },
      {
        speaker: "A",
        japanese: "おげんきですか。",
        reading: "O-genki desu ka?",
        english: { en: "How are you?", np: "तपाईंलाई कस्तो छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、げんきです。あなたは。",
        reading: "Hai, genki desu. Anata wa?",
        english: { en: "Yes, I'm fine. And you?", np: "हो, ठिक छु। तपाईंलाई नि?" },
      },
      {
        speaker: "A",
        japanese: "わたしもげんきです。",
        reading: "Watashi mo genki desu.",
        english: { en: "I'm fine too.", np: "मलाई पनि ठिकै छ।" },
      },
      {
        speaker: "B",
        japanese: "きのうはさむかったですが、きょうはあついです。",
        reading: "Kinō wa samukatta desu ga, kyō wa atsui desu.",
        english: { en: "Yesterday was cold, but today is hot.", np: "हिजो जाडो थियो, तर आज गर्मी छ।" },
      },
      {
        speaker: "A",
        japanese: "そうですね。てんきはあまりよくないですね。",
        reading: "Sō desu ne. Tenki wa amari yokunai desu ne.",
        english: { en: "That's right. The weather isn't very good, is it.", np: "हो नि। मौसम त्यति राम्रो छैन, हगि।" },
      },
      {
        speaker: "B",
        japanese: "いいえ、きょうはいいですよ。",
        reading: "Iie, kyō wa ii desu yo.",
        english: { en: "No, today is good.", np: "होइन, आज त राम्रो छ है।" },
      },
      {
        speaker: "A",
        japanese: "あしたのてんきはどうですか。",
        reading: "Ashita no tenki wa dō desu ka?",
        english: { en: "How is tomorrow's weather?", np: "भोलिको मौसम कस्तो छ?" },
      },
      {
        speaker: "B",
        japanese: "あしたもあついです。",
        reading: "Ashita mo atsui desu.",
        english: { en: "Tomorrow will be hot too.", np: "भोलि पनि गर्मी हुन्छ।" },
      },
      // ── 3. Visiting a friend's house ──────────────────────────────────────
      {
        speaker: "A",
        japanese: "こんにちは。おじゃまします。",
        reading: "Konnichiwa. Ojama shimasu.",
        english: { en: "Hello. Excuse me for intruding.", np: "नमस्ते। म भित्र आउँदैछु है।" },
      },
      {
        speaker: "B",
        japanese: "いらっしゃい。どうぞ、あがってください。おげんきですか。",
        reading: "Irasshai. Dōzo, agatte kudasai. O-genki desu ka?",
        english: { en: "Welcome. Please come in. How are you?", np: "स्वागत छ। भित्र आउनुहोस्। तपाईंलाई कस्तो छ?" },
      },
      {
        speaker: "A",
        japanese: "はい、げんきです。",
        reading: "Hai, genki desu.",
        english: { en: "Yes, I'm fine.", np: "हो, ठिक छु।" },
      },
      {
        speaker: "B",
        japanese: "にほんのせいかつになれましたか。",
        reading: "Nihon no seikatsu ni naremashita ka?",
        english: { en: "Have you got used to life in Japan?", np: "जापानको जीवनशैलीमा घुलमिल हुनुभयो?" },
      },
      {
        speaker: "A",
        japanese: "はい、すこしなれました。でも、まだむずかしいです。",
        reading: "Hai, sukoshi naremashita. Demo, mada muzukashii desu.",
        english: { en: "Yes, I've gotten a little used to it. But it is still difficult.", np: "हो, अलि अलि घुलमिल भएँ। तर अझै कठिन छ।" },
      },
      {
        speaker: "B",
        japanese: "にほんごのべんきょうはどうですか。",
        reading: "Nihongo no benkyō wa dō desu ka?",
        english: { en: "How is your Japanese study?", np: "जापानी भाषाको अध्ययन कस्तो छ?" },
      },
      {
        speaker: "A",
        japanese: "とてもおもしろいですが、かんじがむずかしいです。",
        reading: "Totemo omoshiroi desu ga, kanji ga muzukashii desu.",
        english: { en: "It's very interesting, but kanji is difficult.", np: "धेरै रोचक छ, तर कान्जी कठिन छ।" },
      },
      {
        speaker: "B",
        japanese: "コーヒーをもういっぱいいかがですか。",
        reading: "Kōhī o mō ippai ikaga desu ka?",
        english: { en: "Won't you have another cup of coffee?", np: "कफी अझै एक कप लिनुहुन्छ?" },
      },
      {
        speaker: "A",
        japanese: "いいえ、けっこうです。もうじゅうじですね。そろそろしつれいします。",
        reading: "Iie, kekkō desu. Mō jūji desu ne. Sorosoro shitsurei shimasu.",
        english: { en: "No, thank you. It's already ten o'clock. It's about time for me to leave.", np: "अहँ, धन्यवाद। अब त दस बजिसक्यो। अब जाने बेला भयो।" },
      },
      {
        speaker: "B",
        japanese: "そうですか。またいらっしゃってください。",
        reading: "Sō desu ka. Mata irasshatte kudasai.",
        english: { en: "I see. Please come again.", np: "हो र। फेरि आउनुहोस्।" },
      },
      // ── 4. Comparing two towns ─────────────────────────────────────────────
      {
        speaker: "A",
        japanese: "あなたのまちはにぎやかですか。",
        reading: "Anata no machi wa nigiyaka desu ka?",
        english: { en: "Is your town lively?", np: "तपाईंको सहर चहलपहल भएको छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、とてもにぎやかです。ゆうめいなみせがおおいです。",
        reading: "Hai, totemo nigiyaka desu. Yūmei na mise ga ōi desu.",
        english: { en: "Yes, it is very lively. There are many famous shops.", np: "हो, धेरै चहलपहल छ। धेरै प्रसिद्ध पसलहरू छन्।" },
      },
      {
        speaker: "A",
        japanese: "そうですか。わたしのまちはしずかです。",
        reading: "Sō desu ka. Watashi no machi wa shizuka desu.",
        english: { en: "I see. My town is quiet.", np: "हो र। मेरो सहर शान्त छ।" },
      },
      {
        speaker: "B",
        japanese: "しずかなまちもいいですね。",
        reading: "Shizuka na machi mo ii desu ne.",
        english: { en: "A quiet town is nice too, isn't it.", np: "शान्त सहर पनि राम्रो हुन्छ, हगि।" },
      },
      {
        speaker: "A",
        japanese: "ええ、でもあまりべんりじゃないです。",
        reading: "Ee, demo amari benri ja nai desu.",
        english: { en: "Yes, but it isn't very convenient.", np: "हो, तर त्यति सुविधाजनक छैन।" },
      },
      {
        speaker: "B",
        japanese: "あなたのまちはひろいですか。",
        reading: "Anata no machi wa hiroi desu ka?",
        english: { en: "Is your town spacious?", np: "तपाईंको सहर ठूलो छ?" },
      },
      {
        speaker: "A",
        japanese: "いいえ、あまりひろくないです。ちいさいまちです。",
        reading: "Iie, amari hiroku nai desu. Chiisai machi desu.",
        english: { en: "No, it's not very spacious. It is a small town.", np: "होइन, त्यति ठूलो छैन। सानो सहर हो।" },
      },
      {
        speaker: "B",
        japanese: "でも、しずかでいいですね。",
        reading: "Demo, shizuka de ii desu ne.",
        english: { en: "But it's quiet, which is nice.", np: "तर शान्त छ, त्यो राम्रो हो।" },
      },
      {
        speaker: "A",
        japanese: "あなたのまちはどんなまちですか。",
        reading: "Anata no machi wa donna machi desu ka?",
        english: { en: "What kind of town is your town?", np: "तपाईंको सहर कस्तो सहर हो?" },
      },
      {
        speaker: "B",
        japanese: "にぎやかでたのしいまちです。",
        reading: "Nigiyaka de tanoshii machi desu.",
        english: { en: "It's a lively and enjoyable town.", np: "चहलपहल भएको र रमाइलो सहर हो।" },
      },
      // ── 5. A person's personality ─────────────────────────────────────────
      {
        speaker: "A",
        japanese: "たなかさんはどんなひとですか。",
        reading: "Tanaka-san wa donna hito desu ka?",
        english: { en: "What kind of person is Tanaka?", np: "तानाकाजी कस्तो मान्छे हुनुहुन्छ?" },
      },
      {
        speaker: "B",
        japanese: "とてもしんせつなひとです。",
        reading: "Totemo shinsetsu na hito desu.",
        english: { en: "He is a very kind person.", np: "धेरै दयालु मान्छे हुनुहुन्छ।" },
      },
      {
        speaker: "A",
        japanese: "げんきですか。",
        reading: "Genki desu ka?",
        english: { en: "Is he lively/cheerful?", np: "फुर्तिलो हुनुहुन्छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、いつもげんきです。",
        reading: "Hai, itsumo genki desu.",
        english: { en: "Yes, he's always cheerful.", np: "हो, सधैं फुर्तिलो हुनुहुन्छ।" },
      },
      {
        speaker: "A",
        japanese: "ハンサムですか。",
        reading: "Hansamu desu ka?",
        english: { en: "Is he handsome?", np: "ह्यान्डसम हुनुहुन्छ?" },
      },
      {
        speaker: "B",
        japanese: "ええ、ハンサムです。そして、あたまもいいです。",
        reading: "Ee, hansamu desu. Soshite, atama mo ii desu.",
        english: { en: "Yes, he's handsome. And he's smart too.", np: "हो, ह्यान्डसम हुनुहुन्छ। र, दिमाग पनि तीखो छ।" },
      },
      {
        speaker: "A",
        japanese: "いいひとですね。",
        reading: "Ii hito desu ne.",
        english: { en: "He's a good person, isn't he.", np: "राम्रो मान्छे हुनुहुन्छ, हगि।" },
      },
      {
        speaker: "B",
        japanese: "はい、みんなにしんせつです。",
        reading: "Hai, minna ni shinsetsu desu.",
        english: { en: "Yes, he's kind to everyone.", np: "हो, सबैलाई दयालु हुनुहुन्छ।" },
      },
      {
        speaker: "A",
        japanese: "そうですか。とてもいいひとですね。",
        reading: "Sō desu ka. Totemo ii hito desu ne.",
        english: { en: "I see. He's a very good person.", np: "हो र। धेरै राम्रो मान्छे रहेछ।" },
      },
      {
        speaker: "B",
        japanese: "はい、ほんとうにいいひとです。",
        reading: "Hai, hontō ni ii hito desu.",
        english: { en: "Yes, he's truly a good person.", np: "हो, साँच्चै राम्रो मान्छे हुनुहुन्छ।" },
      },
      // ── 6. Shopping for clothes ────────────────────────────────────────────
      {
        speaker: "A",
        japanese: "このふくはどうですか。",
        reading: "Kono fuku wa dō desu ka?",
        english: { en: "How about these clothes?", np: "यो लुगा कस्तो छ?" },
      },
      {
        speaker: "B",
        japanese: "きれいですね。でも、ちょっとたかいです。",
        reading: "Kirei desu ne. Demo, chotto takai desu.",
        english: { en: "It's pretty. But it's a little expensive.", np: "राम्रो छ। तर अलि महँगो छ।" },
      },
      {
        speaker: "A",
        japanese: "あちらのふくはやすいですよ。",
        reading: "Achira no fuku wa yasui desu yo.",
        english: { en: "Those clothes over there are cheap.", np: "त्यता भएको लुगा सस्तो छ है।" },
      },
      {
        speaker: "B",
        japanese: "ほんとうですか。みてみます。",
        reading: "Hontō desu ka? Mite mimasu.",
        english: { en: "Really? I'll take a look.", np: "साँच्चै हो? हेर्छु।" },
      },
      {
        speaker: "A",
        japanese: "そのいろはあかいですね。",
        reading: "Sono iro wa akai desu ne.",
        english: { en: "That color is red, isn't it.", np: "त्यो रंग रातो छ, हगि।" },
      },
      {
        speaker: "B",
        japanese: "ええ、あかいのはいいですね。",
        reading: "Ee, akai no wa ii desu ne.",
        english: { en: "Yes, the red one is nice.", np: "हो, रातो भएको राम्रो छ।" },
      },
      {
        speaker: "A",
        japanese: "あおいのもありますよ。",
        reading: "Aoi no mo arimasu yo.",
        english: { en: "There's a blue one too.", np: "नीलो भएको पनि छ है।" },
      },
      {
        speaker: "B",
        japanese: "あおいのもきれいですね。どちらがやすいですか。",
        reading: "Aoi no mo kirei desu ne. Dochira ga yasui desu ka?",
        english: { en: "The blue one is pretty too. Which one is cheaper?", np: "नीलो पनि राम्रो छ। कुन सस्तो छ?" },
      },
      {
        speaker: "A",
        japanese: "あかいのはやすいです。あおいのはたかいです。",
        reading: "Akai no wa yasui desu. Aoi no wa takai desu.",
        english: { en: "The red one is cheap. The blue one is expensive.", np: "रातो सस्तो छ। नीलो महँगो छ।" },
      },
      {
        speaker: "B",
        japanese: "では、あかいのをかいます。",
        reading: "Dewa, akai no o kaimasu.",
        english: { en: "Then, I'll buy the red one.", np: "त्यसो भए, रातो नै किन्छु।" },
      },
      // ── 7. Food tasting ─────────────────────────────────────────────────────
      {
        speaker: "A",
        japanese: "このりょうりはどうですか。",
        reading: "Kono ryōri wa dō desu ka?",
        english: { en: "How is this dish?", np: "यो खाना कस्तो छ?" },
      },
      {
        speaker: "B",
        japanese: "とてもおいしいです。",
        reading: "Totemo oishii desu.",
        english: { en: "It's very delicious.", np: "धेरै मिठो छ।" },
      },
      {
        speaker: "A",
        japanese: "あついですか。",
        reading: "Atsui desu ka?",
        english: { en: "Is it hot?", np: "तातो छ?" },
      },
      {
        speaker: "B",
        japanese: "いいえ、あつくないです。ちょうどいいです。",
        reading: "Iie, atsuku nai desu. Chōdo ii desu.",
        english: { en: "No, it's not hot. It's just right.", np: "होइन, तातो छैन। ठ्याक्कै मिल्छ।" },
      },
      {
        speaker: "A",
        japanese: "たかかったですか。",
      ...
      {
        speaker: "B",
        japanese: "いいえ、やすかったです。",
        reading: "Iie, yasukatta desu.",
        english: { en: "No, it was cheap.", np: "होइन, सस्तो थियो।" },
      },
      {
        speaker: "A",
        japanese: "このみせはゆうめいですか。",
        reading: "Kono mise wa yūmei desu ka?",
        english: { en: "Is this shop famous?", np: "यो पसल प्रसिद्ध छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、とてもゆうめいなみせです。",
        reading: "Hai, totemo yūmei na mise desu.",
        english: { en: "Yes, it's a very famous shop.", np: "हो, धेरै प्रसिद्ध पसल हो।" },
      },
      {
        speaker: "A",
        japanese: "では、また、きます。",
        reading: "Dewa, mata, kimasu.",
        english: { en: "Then, I'll come again.", np: "त्यसो भए, फेरि आउँछु।" },
      },
      {
        speaker: "B",
        japanese: "ぜひ、またきてください。",
        reading: "Zehi, mata kite kudasai.",
        english: { en: "Please do come again.", np: "अवश्य, फेरि आउनुहोस्।" },
      },
      // ── 8. Library & study ──────────────────────────────────────────────────
      {
        speaker: "A",
        japanese: "としょかんはしずかですか。",
        reading: "Toshokan wa shizuka desu ka?",
        english: { en: "Is the library quiet?", np: "पुस्तकालय शान्त छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、とてもしずかです。べんきょうにいいです。",
        reading: "Hai, totemo shizuka desu. Benkyō ni ii desu.",
        english: { en: "Yes, it's very quiet. It's good for studying.", np: "हो, धेरै शान्त छ। पढाइको लागि राम्रो छ।" },
      },
      {
        speaker: "A",
        japanese: "ほんはおもしろいですか。",
        reading: "Hon wa omoshiroi desu ka?",
        english: { en: "Are the books interesting?", np: "किताबहरू रोचक छन्?" },
      },
      {
        speaker: "B",
        japanese: "はい、とてもおもしろいです。",
        reading: "Hai, totemo omoshiroi desu.",
        english: { en: "Yes, they're very interesting.", np: "हो, धेरै रोचक छन्।" },
      },
      {
        speaker: "A",
        japanese: "むずかしいですか。",
        reading: "Muzukashii desu ka?",
        english: { en: "Are they difficult?", np: "कठिन छन्?" },
      },
      {
        speaker: "B",
        japanese: "すこしむずかしいですが、たのしいです。",
        reading: "Sukoshi muzukashii desu ga, tanoshii desu.",
        english: { en: "They're a bit difficult, but enjoyable.", np: "अलि कठिन छन्, तर रमाइलो छ।" },
      },
      {
        speaker: "A",
        japanese: "いつもいそがしいですか。",
        reading: "Itsumo isogashii desu ka?",
        english: { en: "Are you always busy?", np: "सधैं व्यस्त हुनुहुन्छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、まいにちいそがしいです。でも、たのしいです。",
        reading: "Hai, mainichi isogashii desu. Demo, tanoshii desu.",
        english: { en: "Yes, I'm busy every day. But it's enjoyable.", np: "हो, हरेक दिन व्यस्त हुन्छु। तर रमाइलो छ।" },
      },
      {
        speaker: "A",
        japanese: "がんばってください。",
        reading: "Ganbatte kudasai.",
        english: { en: "Please do your best.", np: "मेहनत गर्नुहोस्।" },
      },
      {
        speaker: "B",
        japanese: "はい、ありがとうございます。",
        reading: "Hai, arigatō gozaimasu.",
        english: { en: "Yes, thank you.", np: "हो, धन्यवाद।" },
      },
      // ── 9. Colors, car & cherry blossoms ───────────────────────────────────
      {
        speaker: "A",
        japanese: "あなたのくるまはあかいですか。",
        reading: "Anata no kuruma wa akai desu ka?",
        english: { en: "Is your car red?", np: "तपाईंको गाडी रातो हो?" },
      },
      {
        speaker: "B",
        japanese: "いいえ、くろいです。",
        reading: "Iie, kuroi desu.",
        english: { en: "No, it's black.", np: "होइन, कालो हो।" },
      },
      {
        speaker: "A",
        japanese: "しろいくるまもいいですね。",
        reading: "Shiroi kuruma mo ii desu ne.",
        english: { en: "A white car is nice too, isn't it.", np: "सेतो गाडी पनि राम्रो हुन्छ, हगि।" },
      },
      {
        speaker: "B",
        japanese: "ええ、しろいのもいいです。",
        reading: "Ee, shiroi no mo ii desu.",
        english: { en: "Yes, the white one is nice too.", np: "हो, सेतो भएको पनि राम्रो हुन्छ।" },
      },
      {
        speaker: "A",
        japanese: "さくらはどんないろですか。",
        reading: "Sakura wa donna iro desu ka?",
        english: { en: "What color are cherry blossoms?", np: "साकुरा फूल कस्तो रंगको हुन्छ?" },
      },
      {
        speaker: "B",
        japanese: "さくらはしろいはなです。",
        reading: "Sakura wa shiroi hana desu.",
        english: { en: "Cherry blossoms are white flowers.", np: "साकुरा सेतो फूल हो।" },
      },
      {
        speaker: "A",
        japanese: "やまのさくらはきれいですか。",
        reading: "Yama no sakura wa kirei desu ka?",
        english: { en: "Are the cherry blossoms on the mountain pretty?", np: "पहाडको साकुरा फूल राम्रो छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、とてもきれいです。",
        reading: "Hai, totemo kirei desu.",
        english: { en: "Yes, it's very pretty.", np: "हो, धेरै राम्रो छ।" },
      },
      {
        speaker: "A",
        japanese: "はるはいいですね。",
        reading: "Haru wa ii desu ne.",
        english: { en: "Spring is nice, isn't it.", np: "वसन्त ऋतु राम्रो हुन्छ, हगि।" },
      },
      {
        speaker: "B",
        japanese: "はい、はるはとてもきれいです。",
        reading: "Hai, haru wa totemo kirei desu.",
        english: { en: "Yes, spring is very beautiful.", np: "हो, वसन्त ऋतु धेरै सुन्दर हुन्छ।" },
      },
      // ── 10. Busy life & work ────────────────────────────────────────────────
      {
        speaker: "A",
        japanese: "しごとはいそがしいですか。",
        reading: "Shigoto wa isogashii desu ka?",
        english: { en: "Is work busy?", np: "काम व्यस्त छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、とてもいそがしいです。",
        reading: "Hai, totemo isogashii desu.",
        english: { en: "Yes, it's very busy.", np: "हो, धेरै व्यस्त छ।" },
      },
      {
        speaker: "A",
        japanese: "せいかつはたのしいですか。",
        reading: "Seikatsu wa tanoshii desu ka?",
        english: { en: "Is life enjoyable?", np: "जीवन रमाइलो छ?" },
      },
      {
        speaker: "B",
        japanese: "ええ、いそがしいですが、たのしいです。",
        reading: "Ee, isogashii desu ga, tanoshii desu.",
        english: { en: "Yes, it's busy, but enjoyable.", np: "हो, व्यस्त छ, तर रमाइलो छ।" },
      },
      {
        speaker: "A",
        japanese: "しごとはむずかしいですか。",
        reading: "Shigoto wa muzukashii desu ka?",
        english: { en: "Is work difficult?", np: "काम कठिन छ?" },
      },
      {
        speaker: "B",
        japanese: "すこしむずかしいですが、おもしろいです。",
        reading: "Sukoshi muzukashii desu ga, omoshiroi desu.",
        english: { en: "It's a bit difficult, but interesting.", np: "अलि कठिन छ, तर रोचक छ।" },
      },
      {
        speaker: "A",
        japanese: "やすみはありますか。",
        reading: "Yasumi wa arimasu ka?",
        english: { en: "Do you have days off?", np: "बिदा हुन्छ?" },
      },
      {
        speaker: "B",
        japanese: "はい、にちようびはひまです。",
        reading: "Hai, nichiyōbi wa hima desu.",
        english: { en: "Yes, Sunday is free.", np: "हो, आइतबार फुर्सद हुन्छ।" },
      },
      {
        speaker: "A",
        japanese: "ひまなときはなにをしますか。",
        reading: "Hima na toki wa nani o shimasu ka?",
        english: { en: "What do you do when you're free?", np: "फुर्सद हुँदा के गर्नुहुन्छ?" },
      },
      {
        speaker: "B",
        japanese: "ひまなときは、うちでやすみます。",
        reading: "Hima na toki wa, uchi de yasumimasu.",
        english: { en: "When I'm free, I rest at home.", np: "फुर्सद हुँदा घरमा आराम गर्छु।" },
      },
    ],
    grammar: [
      {
