...
export const JP_N5_DAY_TITLES: string[] = [
  ...
  "Chapter 7, プレゼント",
  "Chapter 8, い-adj, な-adj, とても",
  "Chapter 9, すき, きらい, じょうず, わかる",
  "Chapter 10, います, あります, location",
  "Chapter 11, counters, ひとつ, 〜本, 〜枚",
  "Chapter 12, より, いちばん, どちら",
  "Chapter 13, ほしい, たい, purpose に",
  "Chapter 14, て-form, てください, ています",
...
const DAY_EXTRA_TAGS: Record<number, { label: string; slug: string }[]> = {
  ...
  8: [
    { label: "い-adj", slug: "p-i-adj" },
    { label: "な-adj", slug: "p-na-adj" },
    { label: "とても", slug: "p-totemo" },
  ],
  9: [
    { label: "すき", slug: "p-suki" },
    { label: "じょうず", slug: "p-jouzu" },
    { label: "たい", slug: "p-tai" },
    { label: "から", slug: "p-kara-reason" },
  ],
  10: [
    { label: "います", slug: "p-imasu" },
    { label: "あります", slug: "p-arimasu" },
    { label: "に vs で", slug: "p-ni-de" },
  ],
  11: [
    { label: "〜本", slug: "p-hon" },
    { label: "〜枚", slug: "p-mai" },
    { label: "いくつ", slug: "p-ikutsu" },
  ],
  12: [
    { label: "より", slug: "p-yori" },
    { label: "いちばん", slug: "p-ichiban" },
    { label: "どちら", slug: "p-dochira" },
  ],
  13: [
    { label: "ほしい", slug: "p-hoshii" },
    { label: "たい", slug: "p-tai2" },
    { label: "purpose に", slug: "p-purpose-ni" },
  ],
  14: [
    { label: "て-form", slug: "p-te-form" },
    { label: "てください", slug: "p-te-kudasai" },
    { label: "ています", slug: "p-te-imasu" },
  ],
};
