...
export const UI_STRINGS = {
  ...
  "hub.nodejs.subtitle": {
    en: "Thirty days from the event loop to deployment: streams, Fastify, Postgres, auth, observability and Docker. Lessons, quizzes and a project each day.",
    np: "इभेन्ट लूपदेखि डिप्लोइसम्म तीस दिन: स्ट्रिम, Fastify, Postgres, प्रमाणीकरण, अवलोकनीयता र Docker। हरेक दिन पाठ, क्विज र प्रोजेक्ट।",
    jp: "イベントループからデプロイまで30日。ストリーム・Fastify・Postgres・認証・オブザーバビリティ・Docker。毎日レッスンとクイズと課題。",
  },
  "hub.nodejs.cta": {
    en: "Open roadmap →",
    np: "रोडम्याप खोल्नुहोस् →",
  ...
  "nodejsRoadmap.subtitle": {
    ...
    jp: "イベントループ → ストリーム → npm とテスト → Fastify → Postgres → 認証 → オブザーバビリティ → Docker とデプロイ。挙動は Node 24 で計測しています。nodejs.org/docs と突き合わせてください。",
  },
  "nodejsRoadmap.daysListAria": {
    en: "Node.js course days 0 through 30",
    np: "Node.js पाठ्यक्रम दिन ० देखि ३०",
    jp: "Node.js コース 0日目から30日目",
  },
  ...
  "hero.title": {
    en: "Notes, roadmaps, and tracks as I learn — shared in public.",
    np: "म सिक्दै जाँदा नोट, रोडम्याप र ट्र्याक — सार्वजनिक रूपमा।",
    jp: "学びながら作るノート・ロードマップ・トラックを公開しています。",
  },
  "hero.body": {
    en: "Programming tracks across backend, frontend, DevOps, and DSA — plus JLPT Japanese. Follow along at your own pace.",
