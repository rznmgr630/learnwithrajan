  ...
  overview: [
    {
      ...
      jp: "**状態の扱い**（教材では約6分の塊）では、**どのコンポーネントがデータの持ち主か**と、**props で下へ読み取り専用で渡す**流れを固めます。**値とコールバック**、**state と props の違い**、**`children`**、**DevTools**、最後に **Button / Alert** の演習パターンです。",
    },
    {
      ...
      jp: "プレイリストの **08〜14** が以下の見出しに対応します。時間は**目安**です。",
    },
  ],
  sections: [
    {
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**state** はコンポーネントが**持ち、時間で変えられる**データです（`useState` 等）。変わるとその subtree が**再レンダー**されます。兄弟で共有するなら**共通親に state を持ち上げ**、props で配ります。",
          },
        },
        {
          type: "code",
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**props** は親から子への**公開入力**です。シグネチャで分割代入すると読みやすくなります。**要素を props で渡す**こともよくあります。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "コールバックで**子が親に通知**します。props 名は **`on…`** が慣習。親は **`() => …`** で id などを閉じ込めます。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              jp: "**state** — そのコンポーネントが**保持・更新**。変えると再レンダー。",
            },
            {
              ...
              jp: "**派生値**は props と state から計算できるなら、**別の state に複製しない**のが原則です。",
            },
          ],
        },
      ],
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "開始タグと終了タグの**間の JSX** が **`children`** です。カードやレイアウトの**合成**に使います。TypeScript では `ReactNode` 等で型付けできます。",
          },
        },
        {
          type: "code",
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**React Developer Tools** を入れ、**Components** タブでツリーを選び **props / state / hooks** を確認します。**Profiler**は別途パフォーマンス調査に使います。",
          },
        },
        {
          type: "list",
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "親の **`showAlert`** などの state と **Button** で表示を切り替え、**条件付き**で Alert を出します。**`role=\"alert\"`** と閉じた後のフォーカスに配慮します。",
          },
        },
        {
          type: "code",
  ...
  faq: [
    ...
    },
    {
      ...
      answer: {
        ...
        jp: "`handleClick` だけでは `id` を渡せないので、**クロージャ**で包むか、子コンポーネントに `id` を渡して内部で `onSelect(id)` とします。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "**単一ノード**のこともあれば、**複数**では配列になり得ます。数えたり変形するなら **`React.Children`** が安全です。",
      },
    },
    {
      question: {
    ...
    },
    {
      ...
      answer: {
        ...
        jp: "フォーム内では `<button>` の省略形が **`submit`** になりがちです。共有 `Button` は **`type=\"button\"` を既定**にし、送信専用は **`submit`** と明示します。",
      },
    },
    {
      question: {
    ...
    },
    {
      ...
      answer: {
        ...
        jp: "**開閉**は state、**本文**は **`children`** か **`message` prop** のどちらかに揃えるのが一般的です。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "**参照が変わったか**で更新を検知します。インプレース改変は参照が同じのままなので再レンダーされないことがあります。**スプレッドで新オブジェクト**を渡します。",
      },
    },
  ],
  bullets: [
