  ...
  overview: [
    {
      ...
      jp: "3日目は**組み立て**に移ります。**ListGroup** 風コンポーネント、**フラグメント**、**キー付きリスト**、**条件付きレンダー**、**イベント**を扱います。",
    },
    {
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**コンポーネント**は再利用の単位です。**境界**（props → JSX）をはっきりさせ、**小さく分ける**とテストと改修が楽です。今日は**関数コンポーネント**のみ扱います。",
          },
        },
        {
          type: "list",
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**ListGroup** は **props** で項目配列を受け取り、行に **map** します。見た目や `aria` はリスト側に閉じ込め、親は**データとコールバック**を渡す形にします。",
          },
        },
        {
          type: "code",
...
export default ListGroup;`,
        },
        {
          ...
          text: {
            ...
            jp: "**デフォルト引数**と **`?.`** の説明は上のとおり。**`key`** の `\`${label}-${index}\`` は教材向けの折衷で、並び替えや重複ラベルがある本番データでは **一意の id** を使ってください。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "JSX は**親が一つ**という制約があります。余計な `<div>` で `ul` の構造が壊れないよう、**フラグメント**で兄弟をまとめます（**DOM ノードは増えません**）。",
          },
        },
        {
          type: "code",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              jp: "**index を key にする**のは、並び替えない静的リストの例外に近いです。",
            },
          ],
        },
        {
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**`&&`**（**`0` が表示される**罠に注意）、**三項**、先頭の **`return null`**（ガード）から選び、ファイル内で揃えます。",
          },
        },
        {
          type: "code",
  ...
  faq: [
    {
      ...
      answer: {
        ...
        jp: "`.map` が返す**兄弟の並びの一番外**につけます。フラグメントで包むなら**フラグメントに key** が必要です。",
      },
    },
    {
      question: {
    ...
    },
    {
      ...
      answer: {
        ...
        jp: "`0` は表示可能な値なので、`0 && …` は **`0` が表示**されます。**`count > 0`** や三項で避けます。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "小さめなら **インライン arrow で十分**です。巨大化してからメモや委譲を検討します。",
      },
    },
    {
      question: {
    ...
    },
    {
      ...
      answer: {
        ...
        jp: "**問題ありません**。行ごとの UI 状態はよくあります。**`key` を安定**させておけば、親の再レンダーで行が不必要にマウントし直されにくいです。",
      },
    },
    {
      question: {
