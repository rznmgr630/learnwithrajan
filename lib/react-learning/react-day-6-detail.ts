  ...
  overview: [
    {
      ...
      jp: "6日目はコンポーネント内の state です。`useState`、状態の形、純粋なレンダー、Strict Mode、オブジェクト／配列のイミュータブル更新（ネスト含む）、Immer、状態の持ち上げ、最後に state 更新の演習 と ExpandableText です。",
    },
    {
      ...
      jp: "教材は 約41分（イントロ 0m25s 〜 ExpandableText 約 6m22s）。時間は目安です。",
    },
  ],
  sections: [
    {
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "ローカル state は「この UI が覚えておくこと」を表します。冗長な二重フラグを避け、表現を最小に。サーバデータは別レイヤで後から足します。今日は `useState` に集中します。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "`useState` は `[値, セッター]` を返します。`setX(x => …)` の関数型更新で、連打時の古い値に依存しないようにします。更新はバッチされ得るので、直後の `console` は古い値のままかもしれません。",
          },
        },
        {
          type: "code",
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "同じ props と state なら同じ JSX（`Math.random()` や外部変数の破壊的変更、レンダー中の DOM 操作は避ける）。副作用はイベントや `useEffect` へ。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "ネストは各レベルをスプレッドでコピーします。深すぎるならフラット化や Immer を検討します。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "`immer` の `produce` は、書き味はミュータブル、結果はイミュータブルです。ネストしたフォーム向き。`use-immer` もあります。採用はチーム合意で。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "同期が必要なら共通親に state を持ち上げ、値と更新関数を props で渡します（Day 4 の延長）。イミュータブル更新とセットで使います。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "真偽のトグル、上下限付きカウンタ、オブジェクトの部分更新を一画面で練習します。まずはブラウザで全経路を押さえます。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "`expanded` を `useState` で持ち、省略表示と もっと見る／閉じる を切り替えます。`maxLines` などは props で再利用性を上げます。",
          },
        },
        {
          type: "code",
  ...
  faq: [
    {
      ...
      answer: {
        ...
        jp: "`push` は同じ配列参照を変えるだけなので、検知されません。新しい配列を返してください。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "まとまって変わるならオブジェクト。更新頻度が大きく違うなら分ける選択もあります（まず測定）。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "別物です。Immer は更新の書きやすさ用。Redux はグローバルストアなど別の問題を扱います（RTK は内部で Immer を利用）。",
      },
    },
    {
      question: {
    ...
    },
    {
      ...
      answer: {
        ...
        jp: "可能ですが、中身を変えたら新しい参照を渡す必要があります。比較を単純にしたいなら ISO 文字列なども検討されます。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "初期化子は再マウントで再実行されます。毎回変わっては困る値は `useState(() => …)` や方針に応じて `useMemo` を検討します。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "開閉がこの UI 内だけなら内部 stateで十分。URL 同期や永続化なら親に持ち上げて制御します。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "遷移が増えたら `useReducer` が向きます。ここで学んだイミュータブル更新はそのまま reducer に活きます。",
      },
    },
  ],
  bullets: [
