...
const REACT_WEEK_TITLE: Record<string, LocalizedString> = {
  ...
  "react-w4": {
    en: "PHASE 4 — API INTEGRATION, ROUTING, DATA, AND STATE",
    np: "चरण ४ — API Integration, Routing, Data र State",
    jp: "フェーズ 4 — API 統合・ルーティング・データ・状態管理",
  },
  "react-w5": {
    en: "PHASE 5 — NEXT.JS AND MODERN REACT",
...
export function reactDayTitle(day: number): LocalizedString {
  ...
  if (day >= 31) return REACT_DAY_TITLE[day - 21] ?? { en: `Day ${day}`, np: `दिन ${day}`, jp: `Day ${day}` };
