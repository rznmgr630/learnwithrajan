...
const REACT_WEEK_TITLE: Record<string, LocalizedString> = {
  ...
  "react-w2": { en: "PHASE 2 — CORE REACT PATTERNS", np: "चरण २ — Core React Patterns", jp: "フェーズ 2 — コア React パターン" },
  "react-w3": {
    en: "PHASE 3 — REUSABILITY AND APPLICATION PATTERNS",
    np: "चरण ३ — Reusability र Application Patterns",
    jp: "フェーズ 3 — 再利用性とアプリケーションパターン",
  },
  "react-w4": {
    en: "PHASE 4 — APPLICATION DEVELOPMENT",
    np: "चरण ४ — Application Development",
    jp: "フェーズ 4 — アプリケーション開発",
  },
  "react-w5": {
    en: "PHASE 5 — ADVANCED REACT",
    np: "चरण ५ — Advanced React",
    jp: "フェーズ 5 — 高度な React",
  },
  "react-w6": { en: "PHASE 6 — PRODUCTION REACT ENGINEERING", np: "चरण ६ — Production React Engineering", jp: "フェーズ 6 — プロダクション React エンジニアリング" },
...
export function reactDayTitle(day: number): LocalizedString {
  ...
  if (day === 13) {
    return {
      en: "Data Fetching and Server State",
      np: "Data Fetching र Server State",
      jp: "データフェッチとサーバー状態",
    };
  }
  if (day === 14) {
  ...
  if (day === 19) {
    return { en: "Accessibility and Internationalization", np: "Accessibility र Internationalization", jp: "アクセシビリティと国際化" };
  }
  if (day === 20) {
    return { en: "Choosing a React Framework", np: "React Framework छनोट", jp: "React フレームワークの選択" };
  }
  if (day === 21) {
  ...
  if (day === 24) {
    return { en: "TypeScript for React", np: "React का लागि TypeScript", jp: "React のための TypeScript" };
  }
  if (day === 25) {
