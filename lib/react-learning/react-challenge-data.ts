...
export const REACT_TOTAL_DAYS = 47;
...
function reactDayRow(sourceDay: number, tagSlugs: [string, string]): RoadmapDay {
  const day = sourceDay >= 11 ? sourceDay + 21 : sourceDay >= 9 ? sourceDay + 23 : sourceDay + 18;
  return {
    day,
    title: reactDayTitle(day),
    tags: reactTags(tagSlugs),
    detail: REACT_DAY_DETAILS[sourceDay],
  };
}

function reactLessonDayRow(day: number, tagSlugs: [string, string]): RoadmapDay {
  return {
    day,
    title: reactDayTitle(day),
    tags: reactTags(tagSlugs),
...
export const REACT_ROADMAP_WEEKS: RoadmapWeek[] = [
  ...
  },
  {
    ...
    days: [
      ...
      reactLessonDayRow(2, ["props", "components"]),
  ...
  },
  {
    ...
    days: [
      ...
      reactLessonDayRow(7, ["lists", "state"]),
  ...
  },
  {
    ...
    days: [
      reactLessonDayRow(15, ["routing", "navigation"]),
      reactLessonDayRow(16, ["api", "query"]),
  ...
  },
  {
    ...
    days: [
      ...
      reactLessonDayRow(24, ["typescript", "types"]),
      reactLessonDayRow(25, ["architecture", "patterns"]),
  ...
  },
  {
    ...
    days: [
      reactLessonDayRow(26, ["performance", "optimization"]),
