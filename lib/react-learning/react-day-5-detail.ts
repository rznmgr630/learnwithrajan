...
export const REACT_DAY_5_DETAIL: RoadmapDayDetail = {
  overview: [
    ...
    },
    {
      ...
      jp: "再生リストは **約32分**。タイムスタンプは**目安**です。プロジェクトごとに **主軸となるスタイル方針を一つ** 決めると運用が楽です。",
    },
  ],
  sections: [
    {
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "React は **CSS の置き場所**より、**`className` / `style` が DOM に届くか**が本質です。チーム規模や **SSR** に合わせて選びます。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**`.css`** を `main.jsx` やコンポーネントから import。**グローバル**になるので BEM 等かビルドのスコープ化が鍵。**リセットやトークン**に向きます。",
          },
        },
        {
          type: "code",
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**`*.module.css`** を import すると **`styles` オブジェクト**が得られ、ビルド時にクラス名が一意化されます。**`composes:`** でローカルクラスを合成できます。",
          },
        },
        {
          type: "code",
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**styled-components / Emotion** などは JS 内にスタイル。**動的スタイル**に強い一方、**ランタイムコスト**と **SSR 設定**があります。**Vanilla Extract** 等はビルドで静的 CSS に落とします。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "分離は「CSS を遠ざける」ではなく、**責務の境界**をはっきりさせることです。機能単位でまとめ、**デザイントークン**は共有レイヤに置きます。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**`style`** は **キャメルケース**のオブジェクトです。**進捗バー幅**など動的な一回り向き。**`:hover`** は CSS 側が向いています。",
          },
        },
        {
          type: "code",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              jp: "**Radix** 等は**スタイルなし**の高水準プリミティブ。見た目は自分で載せます。",
            },
            {
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**`react-icons`** や **`lucide-react`**、または **SVG コンポーネント**。**装飾なら `aria-hidden`**、操作手段には**ラベル**を。",
          },
        },
        {
          type: "code",
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**グローバル class** を **`*.module.css`** に移し、DevTools で **ハッシュ付きクラス**を確認します。**トークン**は共通ファイルへ。",
          },
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: {
            ...
            jp: "**`liked` の state** と **CSS Modules**（塗りつぶし／線）やアイコンで表現します。**タップ領域**を確保し、必要なら **`prefers-reduced-motion`** で動きを控えめにします。",
          },
        },
        {
          type: "code",
  ...
  faq: [
    ...
    },
    {
      ...
      answer: {
        ...
        jp: "ビルドがファイル由来の**ハッシュ**を付け、**アプリ全体で衝突しない**ようにしています。ソースでは短い名前で書けます。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "移行中はあり得ますが、**方針を文書化**して主軸を一つに寄せるのが無難です。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "インラインは要素に直結しますが、**疑似クラスやメディアクエリ**は別途必要です。**動的な数値**に寄せ、デザイン言語は **class** に。",
      },
    },
    {
      question: {
      ...
      answer: {
        ...
        jp: "丸ごと取り込むと大きくなりやすいので **tree-shaking** と分析ツールで確認します。**ヘッドレス**は見た目分が軽いです。",
      },
    },
    {
      question: {
    ...
    },
    {
      ...
      answer: {
        ...
        jp: "デモなら**子で state**で十分です。他の UI と連動するなら **親に持ち上げ**、Day 4 と同様に props で渡します。",
      },
    },
  ],
  bullets: [
