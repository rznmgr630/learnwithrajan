...
import { JS_DAY_21_DETAIL } from "@/lib/js-learning/js-day-21-detail";
import { JS_DAY_22_DETAIL } from "@/lib/js-learning/js-day-22-detail";
import { JS_DAY_23_DETAIL } from "@/lib/js-learning/js-day-23-detail";
import { JS_DAY_24_DETAIL } from "@/lib/js-learning/js-day-24-detail";
...
import { JS_DAY_30_DETAIL } from "@/lib/js-learning/js-day-30-detail";

export const JS_CURRENT_DAY = 1;
export const JS_TOTAL_DAYS = 30;
...
export const JS_ROADMAP_WEEKS: RoadmapWeek[] = [
  // Week 1 — Core Syntax
  {
    ...
    dotClass: DOT["js-w1"],
    days: [
      jsDayRow(1, ["fundamentals", "internals"]),
      jsDayRow(2, ["fundamentals", "types"]),
      jsDayRow(3, ["fundamentals", "functions"]),
    ],
  },
  // Week 2 — Functions
  {
    ...
    dotClass: DOT["js-w2"],
    days: [
      jsDayRow(4, ["scope", "hoisting"]),
      jsDayRow(5, ["closures", "hof"]),
    ],
  },
  ...
  // Week 4 — this & OOP
  {
    ...
    dotClass: DOT["js-w4"],
    days: [
      jsDayRow(12, ["this", "binding"]),
      jsDayRow(13, ["prototypes", "inheritance"]),
      jsDayRow(14, ["classes", "inheritance"]),
    ],
  },
  ...
  // Week 6 — Async
  {
    ...
    dotClass: DOT["js-w6"],
    days: [
      jsDayRow(16, ["async", "promises"]),
      jsDayRow(17, ["promises", "async"]),
    ],
  },
  // Week 7 — Event Loop
  {
    ...
    dotClass: DOT["js-w7"],
    days: [
      jsDayRow(18, ["event-loop", "async"]),
      jsDayRow(19, ["event-loop", "nodejs"]),
    ],
  },
  // Week 8 — Browser APIs
  {
    ...
    dotClass: DOT["js-w8"],
    days: [
      jsDayRow(20, ["dom", "browser"]),
      jsDayRow(21, ["browser", "async"]),
    ],
  },
  // Week 9 — Advanced Patterns
  {
    ...
    dotClass: DOT["js-w9"],
    days: [
      jsDayRow(22, ["promises", "patterns"]),
      jsDayRow(23, ["generators", "advanced"]),
    ],
  },
  // Week 10 — Memory & Performance
  {
    ...
    dotClass: DOT["js-w10"],
    days: [
      jsDayRow(24, ["memory", "advanced"]),
      jsDayRow(25, ["performance", "advanced"]),
    ],
  },
  // Week 11 — TypeScript
  {
    ...
    dotClass: DOT["js-w11"],
    days: [
      jsDayRow(26, ["typescript", "advanced"]),
    ],
  },
  // Week 12 — Advanced JS
  {
    ...
    dotClass: DOT["js-w12"],
    days: [
      jsDayRow(27, ["advanced", "patterns"]),
      jsDayRow(28, ["patterns", "advanced"]),
    ],
  },
  // Week 13 — Node.js Advanced & Senior
  {
    ...
    dotClass: DOT["js-w13"],
    days: [
      jsDayRow(29, ["nodejs", "advanced"]),
      jsDayRow(30, ["internals", "performance"]),
    ],
  },
];
