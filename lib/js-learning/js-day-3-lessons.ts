  ...
  finalQuiz: [
    {
      ...
      options: [{ en: "0", np: "0", jp: "0" }, { en: "10", np: "10", jp: "10" }],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [{ en: "Throws a SyntaxError", np: "SyntaxError आउँछ", jp: "SyntaxErrorが発生する" }, { en: "Falls through to the next case", np: "अर्को case मा fall-through हुन्छ", jp: "次のケースにフォールスルーする" }],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [{ en: "Flatter, more readable code instead of deep nesting", np: "Deep nesting भन्दा flat, पढ्न सजिलो code", jp: "深いネストの代わりに平坦で読みやすいコード" }, { en: "Faster execution", np: "छिटो execution", jp: "実行の高速化" }],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [{ en: "Skips to the next iteration", np: "अर्को iteration मा जान्छ", jp: "次の反復にスキップする" }, { en: "Exits the loop entirely", np: "Loop पूरै छोड्छ", jp: "ループを完全に終了する" }],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [{ en: "Arrow function", np: "Arrow function", jp: "アロー関数" }, { en: "Function declaration", np: "Function declaration", jp: "関数宣言" }],
      correctIndex: 1,
