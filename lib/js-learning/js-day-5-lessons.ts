  ...
  finalQuiz: [
    {
      ...
      options: [{ en: "No — the closure keeps it alive", np: "होइन — closure ले जिउँदो राख्छ", jp: "いいえ — クロージャが保持し続ける" }, { en: "Yes, immediately", np: "हो, तुरुन्तै", jp: "はい、すぐに" }],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [{ en: "Variables staying alive in memory longer than needed", np: "Variable अनुमान भन्दा बढी समय memory मा रहनु", jp: "変数が必要以上に長くメモリに残る" }, { en: "Slower execution", np: "ढिलो execution", jp: "実行が遅くなる" }],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [{ en: "It runs asynchronously", np: "Asynchronously चल्छ", jp: "非同期で実行される" }, { en: "It takes or returns a function", np: "यसले function लिन्छ वा return गर्छ", jp: "関数を受け取るか返す" }],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [{ en: "Right to left", np: "दायाँबाट बायाँ", jp: "右から左" }, { en: "Left to right", np: "बायाँबाट दायाँ", jp: "左から右" }],
      correctIndex: 1,
