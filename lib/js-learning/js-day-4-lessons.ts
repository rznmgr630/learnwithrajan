  ...
  finalQuiz: [
    {
      ...
      options: [{ en: "The entire enclosing function", np: "सम्पूर्ण enclosing function", jp: "囲む関数全体" }, { en: "Only inside the if block", np: "if block भित्र मात्र", jp: "ifブロック内のみ" }],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [{ en: "ReferenceError", np: "ReferenceError", jp: "ReferenceError" }, { en: "undefined", np: "undefined", jp: "undefined" }],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [{ en: "ReferenceError (TDZ)", np: "ReferenceError (TDZ)", jp: "ReferenceError（TDZ）" }, { en: "undefined", np: "undefined", jp: "undefined" }],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [{ en: "No — shadowing only starts after the declaration line", np: "होइन — shadowing declaration line पछि मात्र सुरु हुन्छ", jp: "いいえ — シャドーイングは宣言行の後にのみ始まる" }, { en: "Yes — shadowing applies to the whole enclosing block", np: "हो — shadowing पूरै enclosing block मा लागू हुन्छ", jp: "はい — シャドーイングは囲むブロック全体に適用される" }],
      correctIndex: 1,
